...
?>
        ...
        <!-- Выбор типа лица -->
        <section class="w-full responsive-container py-6 sm:py-8 md:py-10 flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-5 lg:gap-10" data-aos="fade-up" data-aos-delay="100" data-service-name="УКЭП">
            <!-- Юридическое лицо -->
...
if ( function_exists( 'enotary_certificate_help_button_html' ) ) {
    enotary_certificate_help_button_html( 'Заказ УКЭП' );
}
