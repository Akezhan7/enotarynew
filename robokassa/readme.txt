...
== Changelog ==
= 1.8.4 =
* Добавлена поддержка тестового режима для iframe
* Добавлен редирект после оплаты в iframe
* Добавлено уведомление если включены встроенные налоговые ставки WooCommerce
* Добавлены новые налоговые ставки
* Повышена рекомендуемая версия PHP
* Небольшие оптимизационные улучшения

= 1.8.3 =
* Добавлен функционал выбора НДС для конкретного товара
* Добавлен функционал передача признака "Агенский товар" в чек для пользователей [Робокасса Онлайн](https://robokassa.com/online-check/robokassa-online/)
* Переведены SQL-запросы плагина на API `$wpdb` с подготовкой через `prepare()` для совместимости с управляемыми хостингами
* Добавлено логирование ошибок базы данных через `$wpdb->last_error` при сбоях запросов
* Небольшие улучшения дизайна и верстки блоков в админ-панели плагина

= 1.8.2 =
* Доработан функционал загрузки бейджей и виджетов
* Различные мелкие улучшения и фиксы
* Добавлен выбор признака расчета для второго чека
...
* Добавлены универсальные виджеты и бейджи
* Различные мелкие улучшения и фиксы 
